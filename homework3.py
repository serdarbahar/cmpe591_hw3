...
from agent import AC_Agent as Agent # change agent if needed
...
if __name__ == "__main__":
    ...
    for i in tqdm(range(num_episodes)):     
        ...
        tqdm.write(f"Episode {i+1}/{num_episodes}: Steps: {episode_steps}, Cumulative Reward: {cumulative_reward:.2f}")
